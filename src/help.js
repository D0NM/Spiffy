...
//        layer.init();
        layer.init( cc.c4b(25,10,25,255), cc.c4b(200,50,20,255), cc.p(-0.31,1.2));


        var text = cc.LabelTTF.create(
            "How to play Spiffy Tripp:\nUse arrow keys to move Tukki.\nUse SPACE to jump or smfn'\n \nКак играть в Спифи Тип:\nТукки управляем стрелочками.\nПРОБЕЛ - прыжок и усиление.",
            "Impact", 18, cc.size(310, 230), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
        /*
